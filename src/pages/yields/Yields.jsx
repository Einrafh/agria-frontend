                ...
                <div className={`${styles.boxWidth}`}>
                    <div className="flex flex-row gap-x-20">
                        ...
                        <div>
                            ...
                            <div>
                                <div className="flex flex-row mt-6 mb-9 items-center gap-x-6">
                                    <NumberInput/>
                            ...
                            <div className="flex flex-row gap-x-6">
                                <button
                                    className="w-[312px] h-[64px] bg-secondary rounded-lg font-dmSans font-bold text-white text-xl">
                                    Masukkan Keranjang
                                </button>
                                <a
                                    href=""
                                    className="flex flex-col w-[312px] h-[64px] border-2 border-secondary rounded-lg font-dmSans font-bold text-secondary text-center justify-center text-xl"
                                >
                                    Beli Langsung
                                </a>
                            </div>
